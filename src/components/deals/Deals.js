            ...
            <div style={styles.card}>
                <div>
                    <h3 className="d-flex justify-content-center text-center m-1 text-primary">
                        Save More Today
                        <small className="text-body-secondary m-1"> Handpicked Deals for Quick Carts</small>
                    </h3>
                    <p className="m-2">Fresh finds, fair prices, fast checkout—limited availability to keep it real and rewarding.</p>
                </div>
